...
class LinkEventORM(models.Model):
    ...
    link = fields.ForeignKeyField(LinkORM, related_name="events", on_delete=fields.CASCADE)
...
class LinkSessionORM(models.Model):
    ...
    contact_id = fields.UUIDField(null=True)
    link = fields.ForeignKeyField(LinkORM, related_name="sessions", on_delete=fields.CASCADE)
...
class LinkAnalyticsORM(models.Model):
    link = fields.ForeignKeyField(LinkORM, related_name="analytics", on_delete=fields.CASCADE)
